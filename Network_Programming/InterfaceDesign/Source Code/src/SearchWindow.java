...
public class SearchWindow {
	...
	public SearchWindow() {
		...
		TfQueryText.setBounds(120, 50, 280, 30);
		...
		btnQuery.setBounds(200, 100, 90, 30);
		panel.add(btnQuery);
		...
		btnCancel.setBounds(310, 100, 90, 30);
		panel.add(btnCancel);

		LbSearchHint = new JLabel("Enter student's name or ID to search: ");
		LbSearchHint.setBounds(120, 18, 280, 30);
		LbSearchHint.setFont(new Font("Times New Roman", Font.PLAIN, 16));
